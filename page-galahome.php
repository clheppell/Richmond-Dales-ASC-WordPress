  ...
  <div class="bg-dark py-0">
    <div class="container">
      <div class="row mb-4 text-white">
          ...
          <h1 class="mt-3 sr-only">Chester-le-Street Open Meet 2019</h1>
          <img src="/wp-content/themes/chester/img/openmeet/OpenMeet2019SingleLineWebWhite.svg" class="my-4 d-block" style="height:3.0rem;">
          <p class="mb-0"><strong>Tweet about today</strong> Use <a href="https://twitter.com/search?q=%23CLSOpen" target="_blank" class="text-white">#CLSOpen</a></p>
      ...
      <div class="row pb-4 mb-4">
        <div class="col">
          ...
          <div class="news-grid">
            <!--<a target="_blank" href="/downloads/galas/open-meet-2019">
            ...
            <a href="/competitions/galas/chester-le-street-open-meet-2019#results" target="_blank">
              <span class="title">Gala Results</span>
              <span class="category "><abbr title="PDF Files may be harder to view on mobile phones">PDF</abbr></span>
            </a>

            <a href="/wp-content/uploads/2018/10/CLS-Open-2019-draft-programme-1.0.pdf" target="_blank">
            ...
            <a href="/competitions/galas/chester-le-street-open-meet-2019#events">
            ...
            <a href="/competitions/galas/chester-le-street-open-meet-2019/">
              <span class="title">Open Meet Website</span>
              <span class="category ">Galas</span>
            </a>
          </div>
