                    ...
                    <form action="<?php the_permalink(); ?>" method="post" class="form-horizontal" id="contact-form-link">
                      ...
                      <div class="custom-controls-stacked mb-2">
                        ...
                        <div class="custom-control custom-radio">
                          ...
                          <label class="custom-control-label" for="inlineRadio2">Membership Enquiries (Current Members Only)</label>
                        </div>
                        <div class="custom-control custom-radio">
                      ...
                      <p>
                        If you wish to join the club, you should <a
                        href="https://membership.chesterlestreetasc.co.uk/services/request-a-trial">complete
                        the request a trial form instead</a>.
                      </p>
